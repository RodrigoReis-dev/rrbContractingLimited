      ...
      <section className="bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center px-10 py-3 text-base font-medium text-center text-white border border-gray-500 rounded-lg hover:bg-lime-500 hover:text-gray-900 focus:ring-4 focus:ring-gray-100 tracking-wide"
            >
              Speak to Us
            </Link>
          </div>
