      ...
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className="max-w-screen-xl px-4 md:px-8 mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-x-4 md:gap-x-6 gap-y-8">
            {/* <!-- product - start --> */}
            <div>
              <div className="group h-64 block rounded-lg overflow-hidden relative mb-2 lg:mb-3">
                <img
              ...
              <div>
                <div className="text-gray-700 hover:gray-800 lg:text-lg transition duration-100 mb-1">
                  Interior Painting
                </div>
              </div>
            </div>
