...
const Contact5 = () => {
  ...
  return (
    <div className="relative mx-auto w-full bg-black opacity-90 tracking-wide mt-28 mb-44 shadow-2xl">
      <div className="grid grid-cols-2">
        ...
        <div className="order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6 font-medium">
          <form
            action=""
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                name="name"
                placeholder="Name"
                className="form-input w-full block p-2 shadow-sm rounded border-gray-300 bg-white text-base placeholder-gray-500 focus:border-green-400 focus:ring-1 focus:ring-green-400"
              />
            </div>
            {/* ::Email Input */}
            <div>
            ...
            <div className="col-span-full">
              ...
              <textarea
                ...
                className="form-textarea resize-none p-2 w-full shadow-sm rounded border-gray-300 bg-gray-100 placeholder-gray-500 focus:border-green-400 focus:ring-green-400"
              ></textarea>
            </div>
            {/* ::Submit Button */}
            <div>
              <button
                type="submit"
                className="py-2 px-6 rounded bg-secondary text-base text-white font-semibold uppercase hover:bg-secondary-focus hover:text-neutral"
              >
                Send Message
              </button>
            </div>
        ...
        <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <div className="mx-auto max-w-xl flex flex-col space-y-5">
            {/* ::Title Contact Us */}
            <h2 className="text-4xl font-oswald uppercase text-base-100 font-semibold">Contact us</h2>
            {/* ::Text */}
