...
export default function Footer() {
  return (
    <div className="w-full max-h-56 mx-auto">
      <footer className="footer p-2 bg-white text-base-content boder border-t-2 border-secondary-focus">
        {/* <div>
      ...
      <footer className="footer px-10 py-5 text-base-content bg-base-200">
